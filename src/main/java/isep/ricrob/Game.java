...
public class Game {
    ...
    // Un certain mec des années trente avec une moustache bizarre avec les cheveux plaqués quoi
    ...
    // La cible
    //Ligne 18 suffit, pas besoin de commenter
        ...
        if (this.status == CHOOSE_TILE) {
            if (
                ...
                if (checkIfWin()){
                    ...
                    return "Tu as gagné ! En même temps c'était trop facile...\r Hehe, j'ai failli te troll.. SIUUUU";
    ...
    public enum Status {
        ...
        PLAYER_WIN_TOKEN("Haha ! Le temps écoule encore, appuies sur le bouton pour gagner...\r");
